...
static inline void butterfly_3_1(MFFTELEM* __restrict__ Y, MFFTELEM* __restrict__ X,
  ...
  for (int8_t i = 0; i < N2; ++i) {
    ...
    auto d0 = c1 + c2;
    auto d1 = c0 - c30 * d0;
    auto d2 = times_pmim<Inverse>((c31 * (c1 - c2)));
...
static inline void butterfly_5_1(MFFTELEM* __restrict__ Y, MFFTELEM* __restrict__ X,
  ...
  for (int8_t i = 0; i < N2; ++i) {
    ...
    auto d7 = d6 + d5;
    auto d8 = d6 - d5;
    auto d9 = times_pmim<Inverse>((d2 + c53 * d3));
    auto d10 = times_pmim<Inverse>((c53 * d2 - d3));
...
static inline void butterfly_7_1(MFFTELEM* __restrict__ Y, MFFTELEM* __restrict__ X,
  ...
  for (int i = 0; i < N2; ++i) {
    ...
    auto m3 = c73 * a9;
    auto m4 = c74 * a10;
    auto m5 = times_pmim<Inverse>((c75 * a11));
    auto m6 = times_pmim<Inverse>((c76 * a12));
    auto m7 = times_pmim<Inverse>((c77 * a13));
    auto m8 = times_pmim<Inverse>((c78 * a14));
    auto x1 = c0 - m1;
    auto x2 = x1 + m2 + m3;
    auto x3 = x1 - m2 - m4;
    auto x4 = x1 - m3 + m4;
...
void small_3(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1, const int64_t bp,
  ...
  butterfly_3_1<Inverse>(Y, X, n_map, 3, 1, bp, stride, flags);
}
...
void small_4(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1, const int64_t bp,
  ...
  butterfly_4_1<Inverse>(Y, X, n_map, 4, 1, bp, stride, flags);
}
...
void small_5(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1, const int64_t bp,
  ...
  auto d8 = d6 - d5;
  auto d9 = d2 + c53 * d3;
  d9 = times_pmim<Inverse>(d9);
  auto d10 = c53 * d2 - d3;
  d10 = times_pmim<Inverse>(d10);
  Y[bp] = (c0 + d4);
  Y[bp + stride * 1] = (d7 + d9);
...
void small_6(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1, const int64_t bp,
  ...
  butterfly_3_1<Inverse>(Y, X, n_map, 3, 2, bp, stride, flags);
  butterfly_2_2<Inverse>(X, Y, k_map, 3, 2, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_7(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1, const int64_t bp,
  ...
  butterfly_7_1<Inverse>(Y, X, n_map, 7, 1, bp, stride, flags);
}
...
void small_8(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1, const int64_t bp,
  ...
  butterfly_8_1<Inverse>(Y, X, n_map, 8, 1, bp, stride, flags);
}
...
void small_9(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1, const int64_t bp,
  ...
  butterfly_9_1<Inverse>(Y, X, n_map, 9, 1, bp, stride, flags);
}
...
void small_10(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1, const int64_t bp,
  ...
  butterfly_5_1<Inverse>(Y, X, n_map, 5, 2, bp, stride, flags);
  butterfly_2_2<Inverse>(X, Y, k_map, 5, 2, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_12(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1, const int64_t bp,
  ...
  butterfly_4_1<Inverse>(Y, X, n_map, 4, 3, bp, stride, flags);
  butterfly_3_2<Inverse>(X, Y, k_map, 4, 3, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_14(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1, const int64_t bp,
  ...
  butterfly_7_1<Inverse>(Y, X, n_map, 7, 2, bp, stride, flags);
  butterfly_2_2<Inverse>(X, Y, k_map, 7, 2, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_15(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1, const int64_t bp,
  ...
  butterfly_5_1<Inverse>(Y, X, n_map, 5, 3, bp, stride, flags);
  butterfly_3_2<Inverse>(X, Y, k_map, 5, 3, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_18(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1, const int64_t bp,
  ...
  butterfly_9_1<Inverse>(Y, X, n_map, 9, 2, bp, stride, flags);
  butterfly_2_2<Inverse>(X, Y, k_map, 9, 2, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_20(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1, const int64_t bp,
  ...
  butterfly_5_1<Inverse>(Y, X, n_map, 5, 4, bp, stride, flags);
  butterfly_4_2<Inverse>(X, Y, k_map, 5, 4, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_21(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1, const int64_t bp,
  ...
  butterfly_7_1<Inverse>(Y, X, n_map, 7, 3, bp, stride, flags);
  butterfly_3_2<Inverse>(X, Y, k_map, 7, 3, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_24(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1, const int64_t bp,
  ...
  butterfly_8_1<Inverse>(Y, X, n_map, 8, 3, bp, stride, flags);
  butterfly_3_2<Inverse>(X, Y, k_map, 8, 3, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_28(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1, const int64_t bp,
  ...
  butterfly_7_1<Inverse>(Y, X, n_map, 7, 4, bp, stride, flags);
  butterfly_4_2<Inverse>(X, Y, k_map, 7, 4, bp, stride, flags);
  *YY = X;
  *XX = Y;
}

static const fft_func_t small_funcs[] = {
    nullptr,   &small_1<false>, &small_2<false>,  &small_3<false>, &small_4<false>,  &small_5<false>,  &small_6<false>,  &small_7<false>,
    &small_8<false>,  &small_9<false>, &small_10<false>, nullptr,  &small_12<false>, nullptr,   &small_14<false>, &small_15<false>,
    nullptr,   nullptr,  &small_18<false>, nullptr,  &small_20<false>, &small_21<false>, nullptr,   nullptr,
    &small_24<false>, nullptr,  nullptr,   nullptr,  &small_28<false>};

static const fft_func_t small_funcs_inverse[] = {
    nullptr,   &small_1<true>, &small_2<true>,  &small_3<true>, &small_4<true>,  &small_5<true>,
    &small_6<true>,  &small_7<true>,  &small_8<true>,  &small_9<true>,  &small_10<true>,
    nullptr,   &small_12<true>, nullptr,   &small_14<true>, &small_15<true>, nullptr,
    nullptr,   &small_18<true>, nullptr,   &small_20<true>, &small_21<true>, nullptr,
    nullptr,   nullptr,  &small_24<true>, nullptr,   nullptr,   nullptr,   &small_28<true>};
