...
void nmap_2(MFFTELEM *__restrict__ Y, MFFTELEM *__restrict__ X,
            const int64_t bp, const int64_t stride, const int64_t N1,
            const int64_t N2, const int64_t Q1P) {
  // Forward mapping
...
void kmap_2(MFFTELEM *__restrict__ Y, MFFTELEM *__restrict__ X,
            const int64_t bp, const int64_t stride, const int64_t N1,
            const int64_t N2, const int64_t Q2P) {
...
void nmap_3(MFFTELEM *__restrict__ Y, MFFTELEM *__restrict__ X,
            const int64_t bp, const int64_t stride, const int64_t N1,
            const int64_t N2, const int64_t N3, const int64_t Q1P,
            const int64_t Q2P) {
  int64_t rhs_n_stride = bp;
  for (int64_t n1p = 0; n1p < N1; n1p++) {
    int64_t R1 = 0;
...
void kmap_3(MFFTELEM *__restrict__ Y, MFFTELEM *__restrict__ X,
            const int64_t bp, const int64_t stride, const int64_t N1,
            const int64_t N2, const int64_t N3, const int64_t P1,
            const int64_t P2) {
  int64_t lhs_k_stride = bp;
