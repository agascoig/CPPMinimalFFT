...
inline void butterfly_5_1<true>(MFFTELEM* __restrict__ Y, MFFTELEM* __restrict__ X,
  ...
  for (int8_t i = 0; i < N2; ++i) {
    ...
    auto d7 = d6 + d5;
    auto d8 = d6 - d5;
    auto d9 = times_im((d2 + c53 * d3));
    auto d10 = times_im((c53 * d2 - d3));
...
inline void butterfly_5_1<false>(MFFTELEM* __restrict__ Y, MFFTELEM* __restrict__ X,
  ...
  for (int8_t i = 0; i < N2; ++i) {
    ...
    auto d7 = d6 + d5;
    auto d8 = d6 - d5;
    auto d9 = times_nim((d2 + c53 * d3));
    auto d10 = times_nim((c53 * d2 - d3));
    Y[bp + stride * (iN1)] = (c0 + d4);
    Y[bp + stride * (iN1 + 1)] = (d7 + d9);
    Y[bp + stride * (iN1 + 2)] = (d8 + d10);
    Y[bp + stride * (iN1 + 3)] = (d8 - d10);
...
inline void butterfly_7_1<true>(MFFTELEM* __restrict__ Y, MFFTELEM* __restrict__ X,
  ...
  for (int i = 0; i < N2; ++i) {
    ...
    auto m3 = c73 * a9;
    auto m4 = c74 * a10;
    auto m5 = times_im((c75 * a11));
    auto m6 = times_im((c76 * a12));
    auto m7 = times_im((c77 * a13));
    auto m8 = times_im((c78 * a14));
    auto x1 = c0 - m1;
    auto x2 = x1 + m2 + m3;
    auto x3 = x1 - m2 - m4;
    auto x4 = x1 - m3 + m4;
...
inline void butterfly_7_1<false>(MFFTELEM* __restrict__ Y, MFFTELEM* __restrict__ X,
  ...
  for (int i = 0; i < N2; ++i) {
    ...
    auto m3 = c73 * a9;
    auto m4 = c74 * a10;
    auto m5 = times_nim((c75 * a11));
    auto m6 = times_nim((c76 * a12));
    auto m7 = times_nim((c77 * a13));
    auto m8 = times_nim((c78 * a14));
    auto x1 = c0 - m1;
    auto x2 = x1 + m2 + m3;
    auto x3 = x1 - m2 - m4;
    auto x4 = x1 - m3 + m4;
...
void butterfly_8_1<true>(MFFTELEM* __restrict__ Y, MFFTELEM* __restrict__ X, const int8_t* n_map,
  ...
  for (int8_t i = 0; i < N2; ++i) {
    ...
    auto m1 = d0 - d2;
    auto m2 = d4 + d6;
    auto m3 = times_im((d4 - d6));
    auto m4 = (MFFTELEMRI)c81 * (d5 - d7);
    auto m5 = times_im((MFFTELEMRI)c81 * (d5 + d7));
    auto m6 = d1 + m4;
    auto m7 = d1 - m4;
    auto m8 = d3 + m5;
    auto m9 = d3 - m5;
...
void butterfly_8_1<false>(MFFTELEM* __restrict__ Y, MFFTELEM* __restrict__ X, const int8_t* n_map,
  ...
  for (int8_t i = 0; i < N2; ++i) {
    ...
    auto m1 = d0 - d2;
    auto m2 = d4 + d6;
    auto m3 = times_nim((d4 - d6));
    auto m4 = (MFFTELEMRI)c81 * (d5 - d7);
    auto m5 = times_nim((MFFTELEMRI)c81 * (d5 + d7));
    auto m6 = d1 + m4;
    auto m7 = d1 - m4;
    auto m8 = d3 + m5;
    auto m9 = d3 - m5;
...
inline void butterfly_9_1<true>(MFFTELEM* __restrict__ Y, MFFTELEM* __restrict__ X,
  ...
  for (int i = 0; i < N2; ++i) {
    ...
    auto s0 = -m3 - m4;
    auto s1 = m5 - m4;
    auto m6 = times_im((MFFTELEMRI)s3u * t10);
    auto m7 = times_im((MFFTELEMRI)s3u * t8);
    auto t16 = -t13 + t14;
    auto m8 = -times_im((MFFTELEMRI)su * t13);
    auto m9 = -times_im((MFFTELEMRI)s4u * t14);
    auto m10 = -times_im((MFFTELEMRI)s2u * t16);
    auto s2 = -m8 - m9;
    auto s3 = m9 - m10;
    auto s4 = m0 + m2 + m2;
    auto s5 = s4 - m1;
...
inline void butterfly_9_1<false>(MFFTELEM* __restrict__ Y, MFFTELEM* __restrict__ X,
  ...
  for (int i = 0; i < N2; ++i) {
    ...
    auto s0 = -m3 - m4;
    auto s1 = m5 - m4;
    auto m6 = times_nim((MFFTELEMRI)s3u * t10);
    auto m7 = times_nim((MFFTELEMRI)s3u * t8);
    auto t16 = -t13 + t14;
    auto m8 = -times_nim((MFFTELEMRI)su * t13);
    auto m9 = -times_nim((MFFTELEMRI)s4u * t14);
    auto m10 = -times_nim((MFFTELEMRI)s2u * t16);
    auto s2 = -m8 - m9;
    auto s3 = m9 - m10;
    auto s4 = m0 + m2 + m2;
    auto s5 = s4 - m1;
...
void small_3<true>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  butterfly_3_1<true>(Y, X, n_map, 3, 1, bp, stride, flags);
}
...
void small_3<false>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  const int8_t n_map[] = {0, 1, 2};
  butterfly_3_1<false>(Y, X, n_map, 3, 1, bp, stride, flags);
}
...
void small_4<true>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  butterfly_4_1<true>(Y, X, n_map, 4, 1, bp, stride, flags);
}
...
void small_4<false>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  const int8_t n_map[] = {0, 1, 2, 3};
  butterfly_4_1<false>(Y, X, n_map, 4, 1, bp, stride, flags);
}
...
void small_5<true>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  const int8_t n_map[] = {0, 1, 2, 3, 4};
  butterfly_5_1<true>(Y, X, n_map, 5, 1, bp, stride, flags);
}
...
void small_5<false>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  const int8_t n_map[] = {0, 1, 2, 3, 4};
  butterfly_5_1<false>(Y, X, n_map, 5, 1, bp, stride, flags);
}
...
void small_6<true>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  butterfly_3_1<true>(Y, X, n_map, 3, 2, bp, stride, flags);
  butterfly_2_2<true>(X, Y, k_map, 3, 2, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_6<false>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  const int8_t n_map[] = {0, 2, 4, 3, 5, 1};
  const int8_t k_map[] = {0, 4, 2, 3, 1, 5};
  butterfly_3_1<false>(Y, X, n_map, 3, 2, bp, stride, flags);
  butterfly_2_2<false>(X, Y, k_map, 3, 2, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_7<true>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  butterfly_7_1<true>(Y, X, n_map, 7, 1, bp, stride, flags);
}
...
void small_7<false>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  MFFTELEM* __restrict__ X = *XX;
  const int8_t n_map[] = {0, 1, 2, 3, 4, 5, 6};
  butterfly_7_1<false>(Y, X, n_map, 7, 1, bp, stride, flags);
}
...
void small_8<true>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  butterfly_8_1<true>(Y, X, n_map, 8, 1, bp, stride, flags);
}
...
void small_8<false>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  MFFTELEM* __restrict__ X = *XX;
  const int8_t n_map[] = {0, 1, 2, 3, 4, 5, 6, 7};
  butterfly_8_1<false>(Y, X, n_map, 8, 1, bp, stride, flags);
}
...
void small_9<true>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  butterfly_9_1<true>(Y, X, n_map, 9, 1, bp, stride, flags);
}
...
void small_9<false>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  MFFTELEM* __restrict__ X = *XX;
  const int8_t n_map[] = {0, 1, 2, 3, 4, 5, 6, 7, 8};
  butterfly_9_1<false>(Y, X, n_map, 9, 1, bp, stride, flags);
}
...
void small_10<true>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  butterfly_5_1<true>(Y, X, n_map, 5, 2, bp, stride, flags);
  butterfly_2_2<true>(X, Y, k_map, 5, 2, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_10<false>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  const int8_t n_map[] = {0, 2, 4, 6, 8, 5, 7, 9, 1, 3};
  const int8_t k_map[] = {0, 6, 2, 8, 4, 5, 1, 7, 3, 9};
  butterfly_5_1<false>(Y, X, n_map, 5, 2, bp, stride, flags);
  butterfly_2_2<false>(X, Y, k_map, 5, 2, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_12<true>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  butterfly_4_1<true>(Y, X, n_map, 4, 3, bp, stride, flags);
  butterfly_3_2<true>(X, Y, k_map, 4, 3, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_12<false>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  const int8_t n_map[] = {0, 3, 6, 9, 4, 7, 10, 1, 8, 11, 2, 5};
  const int8_t k_map[] = {0, 9, 6, 3, 4, 1, 10, 7, 8, 5, 2, 11};
  butterfly_4_1<false>(Y, X, n_map, 4, 3, bp, stride, flags);
  butterfly_3_2<false>(X, Y, k_map, 4, 3, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_14<true>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  butterfly_7_1<true>(Y, X, n_map, 7, 2, bp, stride, flags);
  butterfly_2_2<true>(X, Y, k_map, 7, 2, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_14<false>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  butterfly_7_1<false>(Y, X, n_map, 7, 2, bp, stride, flags);
  butterfly_2_2<false>(X, Y, k_map, 7, 2, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_15<true>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  butterfly_5_1<true>(Y, X, n_map, 5, 3, bp, stride, flags);
  butterfly_3_2<true>(X, Y, k_map, 5, 3, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_15<false>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  butterfly_5_1<false>(Y, X, n_map, 5, 3, bp, stride, flags);
  butterfly_3_2<false>(X, Y, k_map, 5, 3, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_18<true>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  butterfly_9_1<true>(Y, X, n_map, 9, 2, bp, stride, flags);
  butterfly_2_2<true>(X, Y, k_map, 9, 2, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_18<false>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  const int8_t n_map[] = {0, 2, 4, 6, 8, 10, 12, 14, 16, 9, 11, 13, 15, 17, 1, 3, 5, 7};
  const int8_t k_map[] = {0, 10, 2, 12, 4, 14, 6, 16, 8, 9, 1, 11, 3, 13, 5, 15, 7, 17};
  butterfly_9_1<false>(Y, X, n_map, 9, 2, bp, stride, flags);
  butterfly_2_2<false>(X, Y, k_map, 9, 2, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_20<true>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  butterfly_5_1<true>(Y, X, n_map, 5, 4, bp, stride, flags);
  butterfly_4_2<true>(X, Y, k_map, 5, 4, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_20<false>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  const int8_t n_map[] = {0, 4, 8, 12, 16, 5, 9, 13, 17, 1, 10, 14, 18, 2, 6, 15, 19, 3, 7, 11};
  const int8_t k_map[] = {0, 16, 12, 8, 4, 5, 1, 17, 13, 9, 10, 6, 2, 18, 14, 15, 11, 7, 3, 19};
  butterfly_5_1<false>(Y, X, n_map, 5, 4, bp, stride, flags);
  butterfly_4_2<false>(X, Y, k_map, 5, 4, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_21<true>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  butterfly_7_1<true>(Y, X, n_map, 7, 3, bp, stride, flags);
  butterfly_3_2<true>(X, Y, k_map, 7, 3, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_21<false>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  const int8_t n_map[] = {0, 3, 6, 9, 12, 15, 18, 7, 10, 13, 16, 19, 1, 4, 14, 17, 20, 2, 5, 8, 11};
  const int8_t k_map[] = {0, 15, 9, 3, 18, 12, 6, 7, 1, 16, 10, 4, 19, 13, 14, 8, 2, 17, 11, 5, 20};
  butterfly_7_1<false>(Y, X, n_map, 7, 3, bp, stride, flags);
  butterfly_3_2<false>(X, Y, k_map, 7, 3, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_24<true>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  butterfly_8_1<true>(Y, X, n_map, 8, 3, bp, stride, flags);
  butterfly_3_2<true>(X, Y, k_map, 8, 3, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_24<false>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  const int8_t k_map[] = {0,  9, 18, 3,  12, 21, 6,  15, 8, 17, 2,  11,
                          20, 5, 14, 23, 16, 1,  10, 19, 4, 13, 22, 7};
  butterfly_8_1<false>(Y, X, n_map, 8, 3, bp, stride, flags);
  butterfly_3_2<false>(X, Y, k_map, 8, 3, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_28<true>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  const int8_t n_map[] = {0,  4,  8,  12, 16, 20, 24, 21, 25, 1,  5,  9,  13, 17,
                          14, 18, 22, 26, 2,  6,  10, 7,  11, 15, 19, 23, 27, 3};
  const int8_t k_map[] = {0,  8,  16, 24, 4,  12, 20, 7,  15, 23, 3,  11, 19, 27,
                          14, 22, 2,  10, 18, 26, 6,  21, 1,  9,  17, 25, 5,  13};
  butterfly_7_1<true>(Y, X, n_map, 7, 4, bp, stride, flags);
  butterfly_4_2<true>(X, Y, k_map, 7, 4, bp, stride, flags);
  *YY = X;
  *XX = Y;
}
...
void small_28<false>(MFFTELEM** YY, MFFTELEM** XX, const int64_t N, const int32_t e1,
  ...
  const int8_t k_map[] = {0,  8,  16, 24, 4,  12, 20, 7,  15, 23, 3,  11, 19, 27,
                          14, 22, 2,  10, 18, 26, 6,  21, 1,  9,  17, 25, 5,  13};
  butterfly_7_1<false>(Y, X, n_map, 7, 4, bp, stride, flags);
  butterfly_4_2<false>(X, Y, k_map, 7, 4, bp, stride, flags);
  *YY = X;
  *XX = Y;
}

static const fft_func_t small_funcs[] = {
    nullptr,          &small_1<false>,  &small_2<false>,  &small_3<false>,  &small_4<false>,
    &small_5<false>,  &small_6<false>,  &small_7<false>,  &small_8<false>,  &small_9<false>,
    &small_10<false>, nullptr,          &small_12<false>, nullptr,          &small_14<false>,
    &small_15<false>, nullptr,          nullptr,          &small_18<false>, nullptr,
    &small_20<false>, &small_21<false>, nullptr,          nullptr,          &small_24<false>,
    nullptr,          nullptr,          nullptr,          &small_28<false>};

static const fft_func_t small_funcs_inverse[] = {
    nullptr,         &small_1<true>,  &small_2<true>,  &small_3<true>,  &small_4<true>,
    &small_5<true>,  &small_6<true>,  &small_7<true>,  &small_8<true>,  &small_9<true>,
    &small_10<true>, nullptr,         &small_12<true>, nullptr,         &small_14<true>,
    &small_15<true>, nullptr,         nullptr,         &small_18<true>, nullptr,
    &small_20<true>, &small_21<true>, nullptr,         nullptr,         nullptr,
    &small_24<true>, nullptr,         nullptr,         nullptr,         &small_28<true>};

bool small_available(const int64_t N) { return (N <= SMALL_SZ) && small_funcs[N] != nullptr; }
