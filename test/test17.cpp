...
int main(int argc, char* argv[]) {
  ...
  for (int n = 1; n <= SMALL_SZ; ++n) {
    if (small_available(n, false)) {
      int64_t N = n;
      fft_func_t fns[MAX_FACTORS] = {nullptr};
      fns[0] = get_small_func(N, false);
      int32_t es = 1;
      test_fft(RNG, "small_dft", bm, 0, N, pc, fc, 1, 1, false, nullptr, &N, fns, &N, &es);
    }
    if (small_available(n, true)) {
      int64_t N = n;
      fft_func_t fns[MAX_FACTORS] = {nullptr};
      fns[0] = get_small_func(N, true);
      int32_t es = 1;
      test_fft(RNG, "small_idft", bm, P_INVERSE, N, pc, fc, 1, 1, false, nullptr, &N, fns, &N, &es);
    }
  }
  ...
  for (int n = 1; n <= DIRECT_SZ; ++n) {
    ...
    int32_t es = 1;
    test_fft(RNG, "direct_dft", bm, 0, N, pc, fc, 1, 1, false, nullptr, &N, fns, &N, &es);
  }
...
#define RUN_DRIVER(radix_arr, nf, bm, inverse, pfa, N_vals, name)                           \
  ...
  RUN_DRIVER(((int[]){2, 3, 5, 7}), 2, bm, 1, true, factor_2, "prime factor 2 test 0 inverse");
  RUN_DRIVER(((int[]){2, 3, 5, 7}), 2, bm, 0, true, factor_2, "prime factor 2 test 1");
  RUN_DRIVER(((int[]){4, 3, 5, 7}), 2, bm, 0, true, factor_2, "prime factor 2 test 2");
  RUN_DRIVER(((int[]){8, 3, 5, 7}), 2, bm, 0, true, factor_2, "prime factor 2 test 3");
  RUN_DRIVER(((int[]){2, 9, 5, 7}), 2, bm, 0, true, factor_2, "prime factor 2 test 4");
  RUN_DRIVER(((int[]){8, 9, 5, 7}), 2, bm, 0, true, factor_2, "prime factor 2 test 5");
  RUN_DRIVER(((int[]){2, 3, 5, 7}), 3, bm, 1, true, factor_3, "prime factor 3 test 0 inverse");
  RUN_DRIVER(((int[]){2, 3, 5, 7}), 3, bm, 0, true, factor_3, "prime factor 3 test 1");
  RUN_DRIVER(((int[]){4, 3, 5, 7}), 3, bm, 0, true, factor_3, "prime factor 3 test 2");
  RUN_DRIVER(((int[]){8, 3, 5, 7}), 3, bm, 0, true, factor_3, "prime factor 3 test 3");
  RUN_DRIVER(((int[]){2, 9, 5, 7}), 3, bm, 0, true, factor_3, "prime factor 3 test 4");
  RUN_DRIVER(((int[]){8, 9, 5, 7}), 3, bm, 0, true, factor_3, "prime factor 3 test 5");
  RUN_DRIVER(((int[]){2}), 1, bm, 0, false, high_radix_factor_1, "radix 2 test");
  RUN_DRIVER(((int[]){3}), 1, bm, 0, false, high_radix_factor_1, "radix 3 test");
  RUN_DRIVER(((int[]){4}), 1, bm, 0, false, high_radix_factor_1, "radix 4 test");
  RUN_DRIVER(((int[]){5}), 1, bm, 0, false, high_radix_factor_1, "radix 5 test");
  RUN_DRIVER(((int[]){7}), 1, bm, 0, false, high_radix_factor_1, "radix 7 test");
  RUN_DRIVER(((int[]){8}), 1, bm, 0, false, high_radix_factor_1, "radix 8 test");
  RUN_DRIVER(((int[]){9}), 1, bm, 0, false, high_radix_factor_1, "radix 9 test");
  RUN_DRIVER(((int[]){2, 3, 5, 7}), 4, bm, 0, true, factor_4, "prime factor 4");
  RUN_DRIVER(((int[]){2, 3, 5, 7, 11, 13, 17}), 5, bm, 0, true, factor_5, "prime factor 5");
